...
\Large LaTeXでプレゼンテーションファイル(PDF)を作成するパッケージ
...
\renewcommand{\kanjifamilydefault}{\gtdefault}
\end{lstlisting}
などとして、フォントの設定をするとよいみたい。

- 上のyamlヘッダは`\setmainfont[]{NotoSansCJKjp}`に変換される。
- LaTeXヘッダの方は日本語フォントを指定している。
